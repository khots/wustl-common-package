...
public class InterModelAssociation extends ModelAssociation implements IInterModelAssociation {
     ...
     * 
     * @hibernate.property name="sourceServiceUrl" column="SOURCE_SERVICE_URL" type="string" length="1000" not-null="true"
     */
     ...
     * 
     * @hibernate.property name="targetServiceUrl" column="TARGET_SERVICE_URL" type="string" length="1000" not-null="true"
     */
     ...
     * 
     * @hibernate.property name="sourceAttributeId" column="SOURCE_ATTRIBUTE_ID" type="long" length="30" not-null="true"
     */
     ...
     * 
     * @hibernate.property name="targetAttributeId" column="TARGET_ATTRIBUTE_ID" type="long" length="30" not-null="true"
     */
    ...
    public int hashCode() {
        int hash = 1;
        if (sourceAttribute != null && targetAttribute != null && sourceServiceUrl != null
                && targetServiceUrl != null) {
            hash *= Constants.HASH_PRIME + sourceAttribute.hashCode() + targetAttribute.hashCode()
                    + sourceServiceUrl.hashCode() + targetServiceUrl.hashCode();
        }
        return hash;
    }
