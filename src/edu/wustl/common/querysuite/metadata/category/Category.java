...
public class Category implements Serializable {
    ...
    public Category copy() {
        ...
        newCategory.setDeEntityId(this.deEntityId);
        CategorialClass newCategorialClass = this.rootClass.copy();
        newCategorialClass.setCategory(newCategory);
        newCategory.setRootClass(newCategorialClass);
        newCategory.setCategoryEntity(this.categoryEntity);
        /*     newCategory.setParentCategory(this.parentCategory.copy());
         
         Set<Category> newSubCategories = new HashSet<Category>();
         for(Category category:subCategories){
         Category categoryCopy = category.copy();
         categoryCopy.setParentCategory(newCategory);
         newSubCategories.add(categoryCopy);
         }
