...
//	public void invokeSetterMethod(String roleName,
//			Class[]parameterTypes,Object objectOnWhichMethodToInvoke, Object...args)
//			throws AuditException
//	{
//		Object returnObject = null;
...
//		try
//		{
//			Class.forName(className).getMethod(functionName, parameterTypes)
...
//			try
//			{
//				Class.forName(className).getMethod(functionName, parameterTypes[0]
//	.getSuperclass()).invoke(objectOnWhichMethodToInvoke, args);
//			}
...
//	parameterTypes[0].getSuperclass().getSuperclass()).invoke(objectOnWhichMethodToInvoke, args);
//				}
//				catch(Exception e2)
//				{
//					e2.printStackTrace();
...
//		try
//		{
//			id = (Long)Class.forName(className).getMethod("getId", null)
//				.invoke(objectOnWhichMethodToInvoke, null);
//		}
//		catch (Exception e)
//		{
...
//		try
//		{
//			Class.forName(className).getMethod("setId", Long.class)
//			.invoke(objectOnWhichMethodToInvoke, id);
//		}
//		catch (Exception e)
//		{
//			e.printStackTrace();
