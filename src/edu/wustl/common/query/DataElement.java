...
public class DataElement implements Serializable
{
	...
	public String toUpperSQLString(int tableSufix) throws SQLException
	{
		...
		if ((fieldType != null)
				&& (Constants.FIELD_TYPE_TEXT.equalsIgnoreCase(fieldType) || Constants.FIELD_TYPE_VARCHAR
	...
	public boolean isIdentifiedField()
	{
		...
		if (identifiedData != null)
		{
			...
			Logger.out.debug(" dataElementFieldName:" + field);
			Logger.out.debug(" identifiedData.contains(dataElementFieldName)***** "
					+ identifiedData.contains(field));
