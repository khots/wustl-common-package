...
public class RelationCondition implements Serializable
{
	...
	{
		return leftDataElement.toSQLString(tableSufix) + " " + operator.toSQLString() + " "
				+ rightDataElement.toSQLString(tableSufix) + " ";
	}
	...
	public String toString()
	{
		try
		{
			String sqlString = leftDataElement.toSQLString(0) + " " + operator.toSQLString() + " "
					+ rightDataElement.toSQLString(0) + " ";
			return sqlString;
		}
