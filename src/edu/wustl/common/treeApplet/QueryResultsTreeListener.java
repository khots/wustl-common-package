	...
	public void valueChanged(TreeSelectionEvent e)
	{
		...
		if (object instanceof JTree)
		{
			...
			if (treeNodeData.getValue().equals(Constants.COLLECTION_PROTOCOL))
			{
				...
				this.nodeName = treeNodeData.getValue() + ":" + treeNodeData.getIdentifier() + ":"
						+ parentNode.getValue() + ":" + parentNode.getIdentifier();
			}
			...
			try
			{
				...
				if (!this.isDisabled
						&& !(nodeName.equals(Constants.ROOT) && viewType
								.equals(Constants.OBJECT_VIEW)))
				{
