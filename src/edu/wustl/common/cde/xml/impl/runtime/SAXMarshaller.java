...
public class SAXMarshaller implements XMLSerializer
{
	 ...
	 */
	public SAXMarshaller(ContentHandler _writer, NamespacePrefixMapper prefixMapper,
			MarshallerImpl _owner)
	{
		this.writer = _writer;
		this.owner = _owner;
		this.nsContext = new NamespaceContextImpl(prefixMapper != null
				? prefixMapper
	...
	public String onIDREF(IdentifiableObject obj) throws SAXException
	{
		...
		if (id == null)
		{
			reportError(new NotIdentifiableEventImpl(ValidationEvent.ERROR, Messages
					.format(Messages.ERR_NOT_IDENTIFIABLE), new ValidationEventLocatorImpl(obj)));
		}
		return id;
	}
	...
	void reconcileID() throws AbortSerializationException
	{
		...
		for (Iterator itr = idReferencedObjects.iterator(); itr.hasNext();)
		{
			...
			reportError(new NotIdentifiableEventImpl(ValidationEvent.ERROR, Messages.format(
					Messages.ERR_DANGLING_IDREF, o.____jaxb____getId()),
