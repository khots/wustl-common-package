...
public class MSVValidator implements XMLSerializer, IDContextProvider2
{
	 ...
	 */
	private MSVValidator(DefaultJAXBContextImpl _jaxbCtx, ValidationContext _ctxt,
	 ...
	 */
	public static void validate(DefaultJAXBContextImpl jaxbCtx, ValidationContext context,
	...
	public void endAttributes() throws SAXException
	{
		if (!acceptor.onEndAttributes(null, null))
		{
			...
			// causes this error.
			StringRef ref = new StringRef();
			StartTagInfo sti = new StartTagInfo(currentElementUri, currentElementLocalName,
					currentElementLocalName, emptyAttributes, this);
	...
	public void endAttribute() throws SAXException
	{
				...
				buf.toString(), this, null, null))
		{
			...
			// report an error
			StringRef ref = new StringRef();
			acceptor.onAttribute2(attNamespaceUri, attLocalName, attLocalName, buf.toString(),
					this, ref, null);
	...
	private void childAsElementBody(Object o, ValidatableObject vo) throws SAXException
	{
		...
		StartTagInfo sti = new StartTagInfo(DUMMY_ELEMENT_NS, intfName,
				intfName/*just pass the local name as QName.*/, emptyAttributes, this);
		...
		{
			RIElement rie = (RIElement) o;
			if (!child.onAttribute2(rie.____jaxb_ri____getNamespaceURI(), rie
					.____jaxb_ri____getLocalName(), rie.____jaxb_ri____getLocalName(), "", null,
					null, null))

				// this object is not a valid member of the wildcard
				context.reportEvent(target, Messages.format(Messages.INCORRECT_CHILD_FOR_WILDCARD,
						rie.____jaxb_ri____getNamespaceURI(), rie.____jaxb_ri____getLocalName()));
		}
