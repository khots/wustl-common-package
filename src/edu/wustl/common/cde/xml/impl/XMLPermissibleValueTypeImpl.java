...
public class XMLPermissibleValueTypeImpl
		implements
			edu.wustl.common.cde.xml.XMLPermissibleValueType,
			...
			edu.wustl.common.cde.xml.impl.runtime.ValidatableObject
{
			...
			throws org.xml.sax.SAXException
	{
		...
		{
			context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this,
		...
		try
		{
			context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _DepthOfHierarchyTree)),
					"DepthOfHierarchyTree");
		}
		catch (java.lang.Exception e)
		{
				...
				edu.wustl.common.cde.xml.impl.runtime.AbstractUnmarshallingEventHandlerImpl
	{
		...
		private void eatText4(final java.lang.String value) throws org.xml.sax.SAXException
		{
			try
			{
				_DepthOfHierarchyTree = javax.xml.bind.DatatypeConverter
