...
public class XMLCDECacheTypeImpl
		implements
			...
			edu.wustl.common.cde.xml.impl.runtime.ValidatableObject
{
			...
			throws org.xml.sax.SAXException
	{
		...
		while (idx2 != len2)
		{
			...
			int idx_1 = idx2;
			context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _XMLCDE.get(idx_1++)),
					"XMLCDE");
			...
			throws org.xml.sax.SAXException
	{
		...
		if (has_RefreshTime)
		{
			...
			try
			{
				context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _RefreshTime)),
						"RefreshTime");
			}
			catch (java.lang.Exception e)
			{
				...
				edu.wustl.common.cde.xml.impl.runtime.AbstractUnmarshallingEventHandlerImpl
	{
				...
				switch (state)
				{
					...
					case 7 :
						...
						if (attIdx >= 0)
						{
							...
							context.getCurrentHandler().enterElement(___uri, ___local, ___qname,
									__atts);
							return;
						}
						attIdx = context.getAttribute("", "lazyLoading");
						...
						if (("name" == ___local) && ("" == ___uri))
						{
							_getXMLCDE()
									.add(
											((edu.wustl.common.cde.xml.impl.XMLCDEImpl) spawnChildFromEnterElement(
													(edu.wustl.common.cde.xml.impl.XMLCDEImpl.class),
		...
		private void eatText2(final java.lang.String value) throws org.xml.sax.SAXException
		{
			try
			{
				_RefreshTime = javax.xml.bind.DatatypeConverter
				...
				switch (state)
				{
					...
					case 7 :
						if (("cache" == ___local) && ("" == ___uri))
						{
							_getXMLCDE()
									.add(
											((edu.wustl.common.cde.xml.impl.XMLCDEImpl) spawnChildFromEnterAttribute(
													(edu.wustl.common.cde.xml.impl.XMLCDEImpl.class),
