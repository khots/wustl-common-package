...
public class XMLCDECACHEImpl extends edu.wustl.common.cde.xml.impl.XMLCDECacheTypeImpl
		implements
			edu.wustl.common.cde.xml.XMLCDECACHE,
					...
					case 1 :
						...
						if (("XMLCDE" == ___local) && ("" == ___uri))
						{
							spawnHandlerFromEnterElement(
									(((edu.wustl.common.cde.xml.impl.XMLCDECacheTypeImpl) edu.wustl.common.cde.xml.impl.XMLCDECACHEImpl.this).new Unmarshaller(
