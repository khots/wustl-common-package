	...
	public static IQuery emptyChildExpression()
	{
		...
		try
		{
			...
			joinGraph.putAssociation(specimenCollectionGroupExpression.getExpressionId(),
					specimenExpression.getExpressionId(), iSpgAndSpecimeAssociation);
//			// Creating output Tree.
	...
	public static IQuery emptyRootExpression()
	{
		...
		try
		{
			...
			ICondition condition = QueryObjectFactory.createCondition(findAttribute(specimenEntity, "id"), RelationalOperator.IsNotNull, null);
...
//			// Creating output Tree.
	 ...
	 * @param participant The Constraint Entity object for Participant.
	 * @param paricipantMedicalId The Constraint Entity object for Participant mediical Identifier.
	 * @return The Expression Object.
	 */
...
//			scgNode.addChild(iSpgAndSpecimeAssociation, createSpecimenOutputEntity(tissueSpecimenEntity));
	...
	public static IQuery createSampleQuery3()
	{
		...
		try
		{
			...
			IQueryEntity moelcularSpecimenConstraintEntity = QueryObjectFactory.createQueryEntity(molecularSpecimenEntity);
...
//			specimenNode.addChild(iSpecimenAndSpecimeAssociation, createSpecimenOutputEntity(fluidSpecimenEntity));
	...
	public static IQuery createNBNSampleQuery2()
	{
		...
		try
		{
			...
			IQueryEntity specimenCharacteristicConstraintEntity = QueryObjectFactory.createQueryEntity(specimenCharacteristicEntity);
...
//			specimenNode.addChild(iSpecimenAndSpecimeAssociation, createSpecimenOutputEntity(specimenEntity));
	...
	public static IQuery createInheritanceQuery2()
	{
		...
		try
		{
			...
			// creating expression for SpecimenCollectionGroup.
			IQueryEntity molecularSpecimenConstraintEntity = QueryObjectFactory.createQueryEntity(molecularSpecimenEntity);
	...
	public static IQuery createInheritanceQuery3()
	{
		...
		try
		{
			...
			IQueryEntity cellSpecimenReviewParamConstraintEntity = QueryObjectFactory.createQueryEntity(cellSpecimenReviewParamEntity);
