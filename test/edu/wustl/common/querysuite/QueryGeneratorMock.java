...
public class QueryGeneratorMock
{
	...
	public static IClass createParticantClass()
	{
		...
		IClass class1 = QueryObjectFactory.createClass("Participant", attributes, null, true);
	 ...
	 * Where Expression1 is : [id in (1,2,3,4) AND birthDate between ('1-1-2000','1-2-2000')] OR [activityStatus = 'Active']
	 * @param participant
	 * @return
	 */
	...
	{
		IExpression expression = new Expression(null, 1);
		expression.addOperand((IExpressionOperand) creatParticipantExpression1(participant));
		ILogicalConnector connector = QueryObjectFactory.createLogicalConnector(
				LogicalOperator.And, 0);
		expression.addOperand(connector, createParticipantRule3(participant));
