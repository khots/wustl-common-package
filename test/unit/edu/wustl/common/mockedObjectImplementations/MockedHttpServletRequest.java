...
public class MockedHttpServletRequest implements HttpServletRequest
{
	...
	public MockedHttpSession mockSession;
	

	public MockedHttpServletRequest(Map<String, Object> attributeMap,
			Map<String, String> parameterMap, MockedHttpSession mockSession)
	{
