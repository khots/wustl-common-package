...
//			e.printStackTrace();
	...
	public void testParticpiantExpression1()
	{
		...
		try
		{
			...
			assertEquals(
					...
					"Select Participant_1.VITAL_STATUS, Participant_1.SOCIAL_SECURITY_NUMBER, Participant_1.GENOTYPE, Participant_1.MIDDLE_NAME, Participant_1.LAST_NAME, Participant_1.IDENTIFIER, Participant_1.GENDER, Participant_1.FIRST_NAME, Participant_1.ETHNICITY, Participant_1.DEATH_DATE, Participant_1.BIRTH_DATE, Participant_1.ACTIVITY_STATUS",
					selectPart);
	...
	public void testParticipantQuery1()
	{
		...
		try
		{
			...
			assertEquals(
					...
					"Select Participant_1.VITAL_STATUS, Participant_1.SOCIAL_SECURITY_NUMBER, Participant_1.GENOTYPE, Participant_1.MIDDLE_NAME, Participant_1.LAST_NAME, Participant_1.IDENTIFIER, Participant_1.GENDER, Participant_1.FIRST_NAME, Participant_1.ETHNICITY, Participant_1.DEATH_DATE, Participant_1.BIRTH_DATE, Participant_1.ACTIVITY_STATUS From catissue_participant Participant_1 left join catissue_part_medical_id ParticipantMedicalIdentif_2 on (Participant_1.IDENTIFIER=ParticipantMedicalIdentif_2.PARTICIPANT_ID) Where (Participant_1.ACTIVITY_STATUS='Active') And(Participant_1.IDENTIFIER in (1,2,3,4) And (Participant_1.BIRTH_DATE<=STR_TO_DATE('1-1-2000','%m-%d-%Y') And Participant_1.BIRTH_DATE>=STR_TO_DATE('1-2-2000','%m-%d-%Y'))) And(ParticipantMedicalIdentif_2.MEDICAL_RECORD_NUMBER='M001')",
					sql);
	...
	public void testParticipantQuery2()
	{
		...
		try
		{
			...
			assertEquals(
					"Incorrect SQL formed for From clause of the Expression !!!",
					"Select Participant_1.VITAL_STATUS, Participant_1.SOCIAL_SECURITY_NUMBER, Participant_1.GENOTYPE, Participant_1.MIDDLE_NAME, Participant_1.LAST_NAME, Participant_1.IDENTIFIER, Participant_1.GENDER, Participant_1.FIRST_NAME, Participant_1.ETHNICITY, Participant_1.DEATH_DATE, Participant_1.BIRTH_DATE, Participant_1.ACTIVITY_STATUS From catissue_participant Participant_1 Where Participant_1.ACTIVITY_STATUS='Active'",
					sql);
		}
		catch (Exception e)
		{
	...
	public void testSampleQuery1()
	{
		...
		try
		{
			...
			assertEquals(
					"Incorrect SQL formed for From clause of the Expression !!!",
					"Select Participant_1.VITAL_STATUS, Participant_1.SOCIAL_SECURITY_NUMBER, Participant_1.GENOTYPE, Participant_1.MIDDLE_NAME, Participant_1.LAST_NAME, Participant_1.IDENTIFIER, Participant_1.GENDER, Participant_1.FIRST_NAME, Participant_1.ETHNICITY, Participant_1.DEATH_DATE, Participant_1.BIRTH_DATE, Participant_1.ACTIVITY_STATUS From catissue_participant Participant_1 left join catissue_coll_prot_reg CollectionProtocolRegistr_2 on (Participant_1.IDENTIFIER=CollectionProtocolRegistr_2.PARTICIPANT_ID) left join catissue_specimen_coll_group SpecimenCollectionGroup_3 on (CollectionProtocolRegistr_2.IDENTIFIER=SpecimenCollectionGroup_3.COLLECTION_PROTOCOL_REG_ID) left join catissue_specimen Specimen_4 on (SpecimenCollectionGroup_3.IDENTIFIER=Specimen_4.SPECIMEN_COLLECTION_GROUP_ID) Where (Participant_1.LAST_NAME like 's%') And((Specimen_4.TYPE='Fixed Tissue') Or(Specimen_4.TYPE='Fresh Tissue'))",
					sql);
		}
		catch (Exception e)
		{
