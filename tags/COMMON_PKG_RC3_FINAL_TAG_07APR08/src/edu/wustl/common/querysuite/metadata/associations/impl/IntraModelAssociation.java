...
public class IntraModelAssociation extends ModelAssociation implements IIntraModelAssociation {
     ...
     * 
     * @hibernate.property name="dynamicExtensionsAssociationId" column="DE_ASSOCIATION_ID" type="long" length="30" not-null="true"
     */
    ...
    /**
     * @param dynamicExtensionsAssociationId the dynamicExtensionsAssociationId to set
     */
    public void setDynamicExtensionsAssociationId(Long dynamicExtensionsAssociationId) {
