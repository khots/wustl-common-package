...
public class QueryBizLogic<Q extends IParameterizedQuery> extends DefaultBizLogic
{
	...
	/*
	 * (non-Javadoc)
	 * @see edu.wustl.common.bizlogic.DefaultBizLogic#preInsert(java.lang.Object,
	...
	/*
	 * @see edu.wustl.common.bizlogic.DefaultBizLogic#retrieve(java.lang.String,
	 *      java.lang.String[], java.lang.String[], java.lang.String[],
	 *      java.lang.Object[], java.lang.String)
	 */
	@Override
	public List<Q> retrieve(String sourceObjectName, String[] selectColumnName,
			...
			String joinCondition) throws DAOException
	{
		...
		{
			throw new RuntimeException("Unable to process object, Exception:"
	...
	private void postProcessExpression(Expression expression)
	{
		...
		Collection<ILogicalConnector> logicalConnectorCollection = expression
				.getLogicalConnectors();
		for (ILogicalConnector logicalConnector : logicalConnectorCollection)
		{
			...
			logicalConnectorImpl.setLogicalOperator(LogicalOperator
					.getLogicalOperator(operatorString));
		}
	}
	...
	private void postProcessAssociation(IAssociation association)
	{
		...
		if (association instanceof InterModelAssociation)
		{
			...
			AttributeInterface sourceAttribute = abstractEntityCache
					.getAttributeById(sourceAttributeId);
			...
			AttributeInterface targetAttribute = abstractEntityCache
					.getAttributeById(targetAttributeId);
		...
		else if (association instanceof IntraModelAssociation)
		{
			...
			AssociationInterface deAssociation = abstractEntityCache
					.getAssociationById(deAssociationId);
	...
	private void preProcessExpression(Expression expression)
	{
		...
		for (ILogicalConnector logicalConnector : logicalConnectorCollection)
		{
			...
			((LogicalConnector) logicalConnector).setOperatorString(logicalOperator
					.getOperatorString());
		}
	}
	...
	private void preProcessRule(IRule rule)
	{
		...
		if (!conditions.isEmpty())
		{
			for (ICondition condition : conditions)
			{
				...
				conditionImpl.setRelationalOperatorString(relationalOperator
	...
	private void preProcessAssociation(IAssociation association)
	{
		if (association instanceof IntraModelAssociation)
		{
			...
			intraModelAssociation.setDynamicExtensionsAssociationId(dynamicExtensionsAssociation
					.getId());
		}
