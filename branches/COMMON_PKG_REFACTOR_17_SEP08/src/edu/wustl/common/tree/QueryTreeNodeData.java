...
public class QueryTreeNodeData implements QueryTreeNode, Serializable
{
	...
	public boolean isChildOf(QueryTreeNode treeNode)
	{
		...
		{
			return ((this.parentObjectIdentifier.equals(node.getIdentifier()) && this.parentObjectName
					.equals(node.getObjectName())) && (this.combinedParentIdentifier.equals(node
					.getCombinedParentIdentifier()) && this.combinedParentObjectName.equals(node
					.getCombinedParentObjectName())));
		}
