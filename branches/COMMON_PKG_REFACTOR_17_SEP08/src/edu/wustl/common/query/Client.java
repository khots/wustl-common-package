...
public class Client extends AbstractClient
{
	...
	public static void setRelationConditionsForRelatedTables()
	{
		relationConditionsForRelatedTables.put(new Relation(Query.PARTICIPANT,
				Query.COLLECTION_PROTOCOL_REGISTRATION), new RelationCondition(new DataElement(
				Query.PARTICIPANT, "Identifier"), new Operator(Operator.EQUAL), new DataElement(
				Query.COLLECTION_PROTOCOL_REGISTRATION, "PARTICIPANT_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.PARTICIPANT,
				Query.PARTICIPANT_MEDICAL_IDENTIFIER), new RelationCondition(new DataElement(
				Query.PARTICIPANT, "Identifier"), new Operator(Operator.EQUAL), new DataElement(
				Query.PARTICIPANT_MEDICAL_IDENTIFIER, "PARTICIPANT_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.COLLECTION_PROTOCOL,
				Query.COLLECTION_PROTOCOL_REGISTRATION), new RelationCondition(new DataElement(
				Query.COLLECTION_PROTOCOL, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.COLLECTION_PROTOCOL_REGISTRATION, "COLLECTION_PROTOCOL_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.COLLECTION_PROTOCOL,
				Query.COLLECTION_PROTOCOL_EVENT), new RelationCondition(new DataElement(
				Query.COLLECTION_PROTOCOL, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.COLLECTION_PROTOCOL_EVENT, "COLLECTION_PROTOCOL_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.COLLECTION_PROTOCOL_EVENT,
				Query.SPECIMEN_COLLECTION_GROUP), new RelationCondition(new DataElement(
				Query.COLLECTION_PROTOCOL_EVENT, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.SPECIMEN_COLLECTION_GROUP, "COLLECTION_PROTOCOL_EVENT_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.SPECIMEN_COLLECTION_GROUP,
				Query.SPECIMEN), new RelationCondition(new DataElement(
				Query.SPECIMEN_COLLECTION_GROUP, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.SPECIMEN, "SPECIMEN_COLLECTION_GROUP_ID")));
		relationConditionsForRelatedTables
				.put(new Relation(Query.DEPARTMENT, Query.USER), new RelationCondition(
						new DataElement(Query.DEPARTMENT, "Identifier"), new Operator(
								Operator.EQUAL), new DataElement(Query.USER, "DEPARTMENT_ID")));
		relationConditionsForRelatedTables
				.put(new Relation(Query.INSTITUTION, Query.USER), new RelationCondition(
						new DataElement(Query.INSTITUTION, "Identifier"), new Operator(
								Operator.EQUAL), new DataElement(Query.USER, "INSTITUTION_ID")));
		relationConditionsForRelatedTables.put(
				new Relation(Query.CANCER_RESEARCH_GROUP, Query.USER), new RelationCondition(
						new DataElement(Query.CANCER_RESEARCH_GROUP, "Identifier"), new Operator(
								Operator.EQUAL), new DataElement(Query.USER,
								"CANCER_RESEARCH_GROUP_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.ADDRESS, Query.USER),
				new RelationCondition(new DataElement(Query.ADDRESS, "Identifier"), new Operator(
						Operator.EQUAL), new DataElement(Query.USER, "ADDRESS_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.CSM_USER, Query.USER),
				new RelationCondition(new DataElement(Query.CSM_USER, "USER_ID"), new Operator(
						Operator.EQUAL), new DataElement(Query.USER, "Identifier")));
		relationConditionsForRelatedTables.put(new Relation(Query.USER, Query.SITE),
				new RelationCondition(new DataElement(Query.USER, "Identifier"), new Operator(
						Operator.EQUAL), new DataElement(Query.SITE, "USER_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.ADDRESS, Query.SITE),
				new RelationCondition(new DataElement(Query.ADDRESS, "Identifier"), new Operator(
						Operator.EQUAL), new DataElement(Query.SITE, "ADDRESS_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.STORAGE_CONTAINER_CAPACITY,
				Query.STORAGE_CONTAINER), new RelationCondition(new DataElement(
				Query.STORAGE_CONTAINER_CAPACITY, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.STORAGE_CONTAINER, "STORAGE_CONTAINER_CAPACITY_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.SPECIMEN_PROTOCOL,
				Query.COLLECTION_PROTOCOL), new RelationCondition(new DataElement(
				Query.SPECIMEN_PROTOCOL, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.COLLECTION_PROTOCOL, "Identifier")));
		relationConditionsForRelatedTables.put(new Relation(Query.USER, Query.SPECIMEN_PROTOCOL),
				new RelationCondition(new DataElement(Query.USER, "Identifier"), new Operator(
						Operator.EQUAL), new DataElement(Query.SPECIMEN_PROTOCOL,
						"PRINCIPAL_INVESTIGATOR_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.USER,
				Query.COLLECTION_COORDINATORS), new RelationCondition(new DataElement(Query.USER,
				"Identifier"), new Operator(Operator.EQUAL), new DataElement(
				Query.COLLECTION_COORDINATORS, "USER_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.COLLECTION_PROTOCOL,
				Query.COLLECTION_COORDINATORS), new RelationCondition(new DataElement(
				Query.COLLECTION_PROTOCOL, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.COLLECTION_COORDINATORS, "COLLECTION_PROTOCOL_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.SPECIMEN_REQUIREMENT,
				Query.COLLECTION_SPECIMEN_REQUIREMENT), new RelationCondition(new DataElement(
				Query.SPECIMEN_REQUIREMENT, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.COLLECTION_SPECIMEN_REQUIREMENT, "SPECIMEN_REQUIREMENT_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.COLLECTION_PROTOCOL_EVENT,
				Query.COLLECTION_SPECIMEN_REQUIREMENT), new RelationCondition(new DataElement(
				Query.COLLECTION_PROTOCOL_EVENT, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.COLLECTION_SPECIMEN_REQUIREMENT,
						"COLLECTION_PROTOCOL_EVENT_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.SPECIMEN_PROTOCOL,
				Query.DISTRIBUTION_PROTOCOL), new RelationCondition(new DataElement(
				Query.SPECIMEN_PROTOCOL, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.DISTRIBUTION_PROTOCOL, "Identifier")));
		...
		relationConditionsForRelatedTables.put(new Relation(Query.DISTRIBUTION_PROTOCOL,
				Query.DISTRIBUTION_SPECIMEN_REQUIREMENT),
				new RelationCondition(new DataElement(Query.DISTRIBUTION_PROTOCOL, "Identifier"),
						new Operator(Operator.EQUAL),
						new DataElement(Query.DISTRIBUTION_SPECIMEN_REQUIREMENT,
								"DISTRIBUTION_PROTOCOL_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.CELL_SPECIMEN_REQUIREMENT,
				Query.SPECIMEN_REQUIREMENT), new RelationCondition(new DataElement(
				Query.CELL_SPECIMEN_REQUIREMENT, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.SPECIMEN_REQUIREMENT, "Identifier")));
		relationConditionsForRelatedTables.put(new Relation(Query.MOLECULAR_SPECIMEN_REQUIREMENT,
				Query.SPECIMEN_REQUIREMENT), new RelationCondition(new DataElement(
				Query.MOLECULAR_SPECIMEN_REQUIREMENT, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.SPECIMEN_REQUIREMENT, "Identifier")));
		relationConditionsForRelatedTables.put(new Relation(Query.TISSUE_SPECIMEN_REQUIREMENT,
				Query.SPECIMEN_REQUIREMENT), new RelationCondition(new DataElement(
				Query.TISSUE_SPECIMEN_REQUIREMENT, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.SPECIMEN_REQUIREMENT, "Identifier")));
		relationConditionsForRelatedTables.put(new Relation(Query.FLUID_SPECIMEN_REQUIREMENT,
				Query.SPECIMEN_REQUIREMENT), new RelationCondition(new DataElement(
				Query.FLUID_SPECIMEN_REQUIREMENT, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.SPECIMEN_REQUIREMENT, "Identifier")));
		relationConditionsForRelatedTables.put(new Relation(Query.STORAGE_TYPE,
				Query.STORAGE_CONTAINER), new RelationCondition(new DataElement(Query.STORAGE_TYPE,
				"Identifier"), new Operator(Operator.EQUAL), new DataElement(
				Query.STORAGE_CONTAINER, "STORAGE_TYPE_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.SITE, Query.STORAGE_CONTAINER),
				new RelationCondition(new DataElement(Query.SITE, "Identifier"), new Operator(
						Operator.EQUAL), new DataElement(Query.STORAGE_CONTAINER, "SITE_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.STORAGE_CONTAINER_CAPACITY,
				Query.STORAGE_CONTAINER), new RelationCondition(new DataElement(
				Query.STORAGE_CONTAINER_CAPACITY, "Identifier"), new Operator(Operator.EQUAL),
				new DataElement(Query.STORAGE_CONTAINER, "STORAGE_CONTAINER_CAPACITY_ID")));
		...
		relationConditionsForRelatedTables.put(new Relation(Query.COLLECTION_PROTOCOL,
				Query.SPECIMEN), new RelationCondition(new DataElement(Query.COLLECTION_PROTOCOL,
				"Identifier"), new Operator(Operator.EQUAL), new DataElement(Query.SPECIMEN,
				"COLLECTION_PROTOCOL_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.COLLECTION_PROTOCOL,
				Query.SPECIMEN), new RelationCondition(new DataElement(Query.COLLECTION_PROTOCOL,
				"Identifier"), new Operator(Operator.EQUAL), new DataElement(Query.SPECIMEN,
				"COLLECTION_PROTOCOL_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.SPECIMEN,
				Query.SPECIMEN_EVENT_PARAMETERS), new RelationCondition(new DataElement(
				Query.SPECIMEN, "Identifier"), new Operator(Operator.EQUAL), new DataElement(
				Query.SPECIMEN_EVENT_PARAMETERS, "SPECIMEN_ID")));
		relationConditionsForRelatedTables.put(new Relation(Query.CHECKIN_CHECKOUT_EVENT_PARAMETER,
				Query.SPECIMEN_EVENT_PARAMETERS), new RelationCondition(new DataElement(
				Query.SPECIMEN, "Identifier"), new Operator(Operator.EQUAL), new DataElement(
				Query.SPECIMEN_EVENT_PARAMETERS, "Identifier")));
	...
	public static void setObjectTableNames()
	{
		...
		objectTableNames.put(Query.PARTICIPANT_MEDICAL_IDENTIFIER, "CATISSUE_PART_MEDICAL_ID");
		objectTableNames.put(Query.COLLECTION_PROTOCOL_REGISTRATION, "CATISSUE_COLL_PROT_REG");
		objectTableNames.put(Query.COLLECTION_PROTOCOL, "CATISSUE_COLLECTION_PROTOCOL");
		objectTableNames.put(Query.COLLECTION_PROTOCOL_EVENT, "CATISSUE_COLL_PROT_EVENT");
		objectTableNames.put(Query.SPECIMEN_COLLECTION_GROUP, "CATISSUE_SPECIMEN_COLL_GROUP");
		...
		objectTableNames.put(Query.CANCER_RESEARCH_GROUP, "catissue_cancer_research_group");
		...
		objectTableNames.put(Query.STORAGE_CONTAINER_CAPACITY, "CATISSUE_STORAGE_CONT_CAPACITY");
		...
		objectTableNames.put(Query.REPORTED_PROBLEM, "catissue_reported_problem");
		objectTableNames.put(Query.CELL_SPECIMEN_REQUIREMENT, "catissue_cell_specimen_requirement");
		...
		objectTableNames.put(Query.STORAGE_CONTAINER, "catissue_storage_container");
		objectTableNames.put(Query.SPECIMEN_EVENT_PARAMETERS, "catissue_specimen_event_param");
		objectTableNames.put(Query.CHECKIN_CHECKOUT_EVENT_PARAMETER, "catissue_in_out_event_param");
	}
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			AdvancedConditionsNode advancedConditionsNode = new AdvancedConditionsNode(
					Query.PARTICIPANT);
			advancedConditionsNode.addConditionToNode(new Condition(new DataElement("Participant",
					"gender", Constants.FIELD_TYPE_VARCHAR), new Operator(Operator.EQUAL),
					"'Female'"));
			...
			advancedConditionsNode9.addConditionToNode(new Condition(new DataElement(
					Query.CHECKIN_CHECKOUT_EVENT_PARAMETER, "STORAGE_STATUS",
					Constants.FIELD_TYPE_VARCHAR), new Operator(Operator.EQUAL), "'CHECK IN'"));
			...
			AdvancedConditionsNode advancedConditionsNode7 = new AdvancedConditionsNode(
					Query.SPECIMEN);
			advancedConditionsNode7.addConditionToNode(new Condition(new DataElement(
					Query.SPECIMEN, "tissue_site", Constants.FIELD_TYPE_TEXT), new Operator(
					Operator.EQUAL), "lung"));
			advancedConditionsNode7.addConditionToNode(new Condition(new DataElement(
					Query.SPECIMEN, "SPECIMEN_TYPE", Constants.FIELD_TYPE_TEXT), new Operator(
					Operator.EQUAL), "'tumor'"));
			...
			AdvancedConditionsNode advancedConditionsNode3 = new AdvancedConditionsNode(
					Query.SPECIMEN);
			advancedConditionsNode3.addConditionToNode(new Condition(new DataElement(new Table(
					Query.SPECIMEN, Query.SPECIMEN + "1LEV", new Table(Query.SPECIMEN,
							Query.SPECIMEN)), "Type", Constants.FIELD_TYPE_TEXT), new Operator(
					Operator.EQUAL), "DNA"));
			advancedConditionsNode3.addConditionToNode(new Condition(new DataElement(new Table(
					Query.SPECIMEN, Query.SPECIMEN + "1LEV", new Table(Query.SPECIMEN,
							Query.SPECIMEN)), "Quantity", Constants.FIELD_TYPE_BIGINT),
