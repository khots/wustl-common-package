...
public class SqlConstants
{
	...
	public static final String SQL_CORRUPTED_ASSOCIATION = "select ASSOCIATION_ID, DE_ASSOCIATION_ID From intra_model_association where de_association_id not in (select IDENTIFIER from dyextn_association)";
	
	public static final String SQL_PATH = "select PATH_ID,FIRST_ENTITY_ID,INTERMEDIATE_PATH,LAST_ENTITY_ID from PATH where INTERMEDIATE_PATH like ";
}
