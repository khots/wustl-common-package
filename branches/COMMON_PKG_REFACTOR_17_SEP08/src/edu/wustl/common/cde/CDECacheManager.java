...
public class CDECacheManager
{
	...
	private void configurePermissibleValues(CDE cde, XMLCDE xmlCDE)
	{
		...
		while (iterator.hasNext())
		{
			XMLPermissibleValueType xmlPermissibleValueType = (XMLPermissibleValueType) iterator
					.next();
			...
			if (permissibleValue != null)
			{
				...
				// If the parent permissible value concept code is not null, set the parent permissible value 
