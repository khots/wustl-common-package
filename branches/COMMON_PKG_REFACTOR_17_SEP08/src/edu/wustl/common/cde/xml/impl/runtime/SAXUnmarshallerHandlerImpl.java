...
public class SAXUnmarshallerHandlerImpl implements SAXUnmarshallerHandler, UnmarshallingContext
{
			...
			throws SAXException
	{
		...
		if (result == null)
		{
			...
			UnmarshallingEventHandler unmarshaller = grammarInfo.createUnmarshaller(uri, local,
					this);
			if (unmarshaller == null)
			{
				...
				throw new SAXParseException(Messages.format(Messages.UNEXPECTED_ROOT_ELEMENT2, uri,
						local, computeExpectedRootElements()), getLocator());
			}
	...
	public void handleEvent(ValidationEvent event, boolean canRecover) throws SAXException
	{
		...
		if (!canRecover || !recover)
			throw new SAXException(new UnmarshalException(event.getMessage(), event
					.getLinkedException()));
	}
