...
public abstract class AbstractUnmarshallingEventHandlerImpl implements UnmarshallingEventHandler
{
	...
	//    
	// internal events
	public void enterElement(String uri, String local, String qname, Attributes atts)
			throws SAXException
	{
	...
	{
		context.handleEvent(new ValidationEventImpl(canRecover
				? ValidationEvent.ERROR
				: ValidationEvent.FATAL_ERROR, msg, new ValidationEventLocatorImpl(context
				.getLocator()), nested), canRecover);
	}

	protected final void unexpectedEnterElement(String uri, String local, String qname,
	...
	protected final void unexpectedEnterAttribute(String uri, String local, String qname)
			throws SAXException
	{
	...
	protected void handleParseConversionException(Exception e) throws SAXException
	{
		...
		ParseConversionEvent pce = new ParseConversionEventImpl(ValidationEvent.ERROR, e
				.getMessage(), new ValidationEventLocatorImpl(context.getLocator()), e);
	...
	protected final Object spawnChildFromEnterElement(Class clazz, int memento, String uri,
			String local, String qname, Attributes atts) throws SAXException
	{
	...
	protected final Object spawnChildFromEnterAttribute(Class clazz, int memento, String uri,
	...
	protected final Object spawnChildFromLeaveElement(Class clazz, int memento, String uri,
			String local, String qname) throws SAXException
	{
		UnmarshallingEventHandler ueh = spawnChild(clazz, memento);
	...
	protected final Object spawnChildFromLeaveAttribute(Class clazz, int memento, String uri,
			String local, String qname) throws SAXException
	{
		UnmarshallingEventHandler ueh = spawnChild(clazz, memento);
	...
	protected final Element spawnWildcard(int memento, String uri, String local, String qname,
			Attributes atts) throws SAXException
	{
		UnmarshallingEventHandler ueh = context.getGrammarInfo().createUnmarshaller(uri, local,
				context);
	...
	protected final void spawnHandlerFromEnterElement(UnmarshallingEventHandler unm, int memento,
	...
	protected final void spawnHandlerFromEnterAttribute(UnmarshallingEventHandler unm, int memento,
	...
	protected final void spawnHandlerFromFromText(UnmarshallingEventHandler unm, int memento,
	...
	protected final void spawnHandlerFromLeaveElement(UnmarshallingEventHandler unm, int memento,
			String uri, String local, String qname) throws SAXException
	{
	...
	protected final void spawnHandlerFromLeaveAttribute(UnmarshallingEventHandler unm, int memento,
			String uri, String local, String qname) throws SAXException
	{
	...
	protected final void spawnHandlerFromText(UnmarshallingEventHandler unm, int memento,
	...
	//
	//    
	protected final void revertToParentFromEnterElement(String uri, String local, String qname,
			Attributes atts) throws SAXException
	{
