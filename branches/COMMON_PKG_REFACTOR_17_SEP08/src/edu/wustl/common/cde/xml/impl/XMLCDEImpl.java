...
public class XMLCDEImpl
		implements
			edu.wustl.common.cde.xml.XMLCDE,
			com.sun.xml.bind.JAXBObject,
			edu.wustl.common.cde.xml.impl.runtime.UnmarshallableObject,
			edu.wustl.common.cde.xml.impl.runtime.XMLSerializable,
			edu.wustl.common.cde.xml.impl.runtime.ValidatableObject
{
	...
	public edu.wustl.common.cde.xml.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
			edu.wustl.common.cde.xml.impl.runtime.UnmarshallingContext context)
	{
			...
			throws org.xml.sax.SAXException
	{
		...
		{
			edu.wustl.common.cde.xml.impl.runtime.Util.handlePrintConversionException(this, e,
					context);
		}
		context.endElement();
		...
		while (idx1 != len1)
		{
			...
			int idx_4 = idx1;
			context.childAsURIs(((com.sun.xml.bind.JAXBObject) _XMLPermissibleValues.get(idx_4++)),
					"XMLPermissibleValues");
			context.endNamespaceDecls();
			int idx_5 = idx1;
			context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _XMLPermissibleValues
					.get(idx_5++)), "XMLPermissibleValues");
			context.endAttributes();
			context.childAsBody(((com.sun.xml.bind.JAXBObject) _XMLPermissibleValues.get(idx1++)),
					"XMLPermissibleValues");
			context.endElement();
		}
	}
			...
			throws org.xml.sax.SAXException
	{
		...
		if (has_Cache)
		{
			...
			try
			{
				context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _Cache)),
						"Cache");
			}
			catch (java.lang.Exception e)
			{
		...
		if (has_LazyLoading)
		{
			...
			try
			{
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _LazyLoading)), "LazyLoading");
			}
			catch (java.lang.Exception e)
			{
				edu.wustl.common.cde.xml.impl.runtime.Util.handlePrintConversionException(this, e,
	...
	public class Unmarshaller
			extends
				edu.wustl.common.cde.xml.impl.runtime.AbstractUnmarshallingEventHandlerImpl
	{
		...
		protected Unmarshaller(edu.wustl.common.cde.xml.impl.runtime.UnmarshallingContext context,
				int startState)
		{
			this(context);
			state = startState;
		...
		public void enterElement(java.lang.String ___uri, java.lang.String ___local,
				java.lang.String ___qname, org.xml.sax.Attributes __atts)
				throws org.xml.sax.SAXException
		{
			int attIdx;
			outer : while (true)
			{
				switch (state)
				{
					...
					case 13 :
						...
						{
							_getXMLPermissibleValues()
									.add(
											((edu.wustl.common.cde.xml.impl.XMLPermissibleValueTypeImpl) spawnChildFromEnterElement(
													(edu.wustl.common.cde.xml.impl.XMLPermissibleValueTypeImpl.class),
		...
		private void eatText1(final java.lang.String value) throws org.xml.sax.SAXException
		{
			try
			{
				_Cache = javax.xml.bind.DatatypeConverter
		...
		private void eatText2(final java.lang.String value) throws org.xml.sax.SAXException
		{
			try
			{
				_LazyLoading = javax.xml.bind.DatatypeConverter
						.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
				has_LazyLoading = true;
			}
			catch (java.lang.Exception e)
