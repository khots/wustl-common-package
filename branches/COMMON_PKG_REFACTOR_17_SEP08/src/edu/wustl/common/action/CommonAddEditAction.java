...
public class CommonAddEditAction extends Action
{
	 ...
	 * @return ActionError
	 */
	private ActionError getErrorForUserNotAuthorized(HttpServletRequest request, UserNotAuthorizedException excp)
	{
    ...
    public ActionForward executeEdit(ActionMapping mapping,HttpServletRequest request,
    		AbstractActionForm abstractForm)throws AssignDataException, BizLogicException, UserNotAuthorizedException, DAOException
    {
		...
		Long.valueOf(abstractForm.getId()), abstractForm);
		if(abstractDomain!=null)
		{
			...
			try
			{
				abstractDomainOld = (AbstractDomainObject) sessionClean.load(Class.forName(objectName), Long.valueOf(abstractForm.getId()));
				IBizLogic bizLogic=getIBizLogic(abstractForm);
     ...
     */
    private void addMessage(ActionMessages messages,
    		AbstractDomainObject abstractDomain,
    		String addoredit, QueryBizLogic queryBizLogic,
    		String objectName)
    {
