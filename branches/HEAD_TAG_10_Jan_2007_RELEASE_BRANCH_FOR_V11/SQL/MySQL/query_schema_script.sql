alter table QUERY_PARAMETERIZED_QUERY drop foreign key FKA272176BBC7298A9;
alter table CATEGORIAL_CLASS drop foreign key FK9651EF32D8D56A33;
alter table CATEGORIAL_CLASS drop foreign key FK9651EF3291B;
alter table QUERY_INTRA_MODEL_ASSOCIATION drop foreign key FKF1EDBDD3BC7298A9;
alter table QUERY_CONSTRAINTS drop foreign key FKE364FCFFD3C625EA;
alter table QUERY_PARAMETERIZED_CONDITION drop foreign key FK9BE75A3EBC7298A9;
alter table QUERY_CONDITION drop foreign key FKACCE6246104CA7;
alter table QUERY_RULE drop foreign key FK14A6503365F8F4CB;
alter table QUERY_RULE drop foreign key FK14A65033BC7298A9;
alter table QUERY drop foreign key FK49D20A8251EDC5B;
alter table QUERY_LOGICAL_CONNECTOR drop foreign key FKCF30478065F8F4CB;
alter table QUERY_EXPRESSION drop foreign key FK1B473A8FCA571190;
alter table QUERY_EXPRESSION drop foreign key FK1B473A8F9E19EF66;
alter table QUERY_EXPRESSION drop foreign key FK1B473A8F1CF7F689;
alter table QUERY_CONDITION_VALUES drop foreign key FK9997379DDA532516;
alter table CATEGORIAL_ATTRIBUTE drop foreign key FK31F77B56E8CBD948;
alter table QUERY_INTER_MODEL_ASSOCIATION drop foreign key FKD70658D1BC7298A9;
alter table QUERY_EXPRESSION_OPERAND drop foreign key FKA3B976F965F8F4CB;
alter table QUERY_GRAPH_ENTRY drop foreign key FKF055E4EA955C60E6;
alter table QUERY_GRAPH_ENTRY drop foreign key FKF055E4EAD3C625EA;
alter table QUERY_GRAPH_ENTRY drop foreign key FKF055E4EA7A5E6479;
alter table QUERY_GRAPH_ENTRY drop foreign key FKF055E4EAEE560703;
alter table CATEGORY drop foreign key FK31A8ACFE2D0F63E7;
alter table CATEGORY drop foreign key FK31A8ACFE211D9A6B;
alter table QUERY_EXPRESSIONID drop foreign key FK6662DBEABC7298A9;
...
alter table CATEGORIAL_CLASS add index FK9651EF3291B (ID), add constraint FK9651EF3291B foreign key (ID) references CATEGORY (ID);
