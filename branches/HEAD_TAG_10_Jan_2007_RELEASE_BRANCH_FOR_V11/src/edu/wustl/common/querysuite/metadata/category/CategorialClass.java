...
public class CategorialClass implements Serializable {
     ...
     * @hibernate.one-to-one column="CATEGORY_ID" class="edu.wustl.common.querysuite.metadata.category.Category" property-ref="rootClass" constrained="true"
     */
     ...
     */
    public void setCategorialAttributeCollection(Set<CategorialAttribute> categorialAttributeCollection) {
    ...
    /**
     * @return
     * @hibernate.set name="categorialAttributeCollection" table="CATEGORIAL_ATTRIBUTE" cascade="save-update" inverse="false" lazy="false"
    ...
    /**
     * @return
     * @hibernate.set name="children" table="CATEGORIAL_CLASS" cascade="save-update" inverse="false" lazy="false"
