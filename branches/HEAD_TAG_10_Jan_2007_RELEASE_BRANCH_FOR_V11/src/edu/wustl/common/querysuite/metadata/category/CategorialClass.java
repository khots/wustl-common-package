...
public class CategorialClass implements Serializable
{
     ...
     */
    public CategorialClass copy() {
        CategorialClass newCategorialClass =  new CategorialClass();
        newCategorialClass.setDeEntityId(this.deEntityId);
        newCategorialClass.setPathFromParent(this.pathFromParent);
        newCategorialClass.setCategorialClassEntity(this.categorialClassEntity);
        
        Set<CategorialClass> newChildren = new HashSet<CategorialClass>();        
        ...
        Set<CategorialAttribute> newCategorialAttributeCollection = new HashSet<CategorialAttribute>();
        for(CategorialAttribute categorialAttribute:this.categorialAttributeCollection) {
            CategorialAttribute newCategorialAttribute = categorialAttribute.copy();
            newCategorialAttribute.setCategorialClass(newCategorialClass);
            
        }
        newCategorialClass.setCategorialAttributeCollection(newCategorialAttributeCollection);
        
         return newCategorialClass;
    }
