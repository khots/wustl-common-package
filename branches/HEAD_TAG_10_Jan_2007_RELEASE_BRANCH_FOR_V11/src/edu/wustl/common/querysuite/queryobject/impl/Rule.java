...
public class Rule extends ExpressionOperand implements IRule {
     ...
     * 
     * @hibernate.list name="conditions" cascade="all-delete-orphan" inverse="false" lazy="false"
     ...
     * 
     * @hibernate.many-to-one column="QUERY_EXPRESSION_ID" class="edu.wustl.common.querysuite.queryobject.impl.Expression" not-null="true" inverse="true"
     * @hibernate.cache usage="read-write"
     */
