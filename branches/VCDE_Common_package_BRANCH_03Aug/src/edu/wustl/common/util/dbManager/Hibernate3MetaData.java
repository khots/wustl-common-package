 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class Hibernate3MetaData
{
...
//		This function finds all the relations and keeps in mappings set.
	...
	private static void saveRelations(Collection col,String rel_type) throws Exception
	{
		...
		List list1=Hibernate3MetaData.getSubClassList(col.getOwner().getClassName());
		...
		List list2=Hibernate3MetaData.getSubClassList(col.getElement().getType().getName());
...
//	Mandar : 26-Apr-06 : 872 : Column width
	...
	public static void main(String[] args) throws Exception
	{
		...
		Hibernate3DBUtil.currentSession();
