...
public class CommonUtilities
{
     ...
     */
    public static boolean checknum(final String num, final int min, final int max)
    {
        boolean flag = true ;
        try
        {
            //Integer value = new Integer(num);
            final Integer value = Integer.valueOf(num);
            if ((min < max))
            {
                final int chkValue = value.intValue();
...
//------------------------------------------------
     ...
     */
    public static boolean isvalidIP(final String ipadd)
    {
        final StringTokenizer strToken = new StringTokenizer(ipadd, ".");
        final int tokenCnt = strToken.countTokens();
        boolean flag = true ;
        if (tokenCnt == 4)
        {
            final String ipPart[] = new String[4];
            int incr = 0;
     ...
     */
    public static boolean checkValue(final int chkValue,final int min,final int max)
    {
        boolean flag = true ;
